import {
    User, Mail, Home, HomeIcon,
    ListChecks, CheckCircle2, Lock, Flame,
  ...
  // COMMON INPUT/BUTTON STYLES (Unified naming)
  ...
  export const INPUTWRAPPER = INPUT_WRAPPER;
  export const Inputwrapper = INPUT_WRAPPER;
...
export const PRODUCTIVITY_CARD = {
  ...
  export const createUserAvatar = (name = 'User') => ({
