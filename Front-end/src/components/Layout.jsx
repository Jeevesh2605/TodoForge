...
const Layout = ({ onLogout, user, children }) => {
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      ...
      <div className='ml-0 xl:ml-72 lg:ml-72 md:ml-20 pt-16 p-3 sm:p-4 md:p-4 transition-all duration-300'>
        {/* Render children if provided (for routes like Profile) */}
        {children && (
          <div className={isSpecialPage ? 'w-full' : 'grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6'}>
            ...
            {/* Only show sidebar stats for dashboard-like pages, not for Profile */}
            {!isSpecialPage && (
        ...
        {/* Render Outlet if no children (for nested routes) */}
        {!children && (
