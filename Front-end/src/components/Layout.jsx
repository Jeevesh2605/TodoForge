...
import { Circle, Clock, Sidebar, Zap } from 'lucide-react';
          ...
          <div className=' xl:col-span-1 space-y-4 sm:space-y-6'>
            <div className=' bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100'>
              ...
              <div className=' grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6'>
                ...
                h-3.5 sm:h-4 text-purple-500' />} />
                <StatCard title='Completed' value= {stats.completedTasks} icon={<Circle className=' w-3.5
                h-3.5 sm:h-4 text-green-500' />} />
                <StatCard title='Pending Tasks' value= {stats.pendingCount} icon={<Circle className=' w-3.5
                h-3.5 sm:h-4 text-fuchsia-500' />} />
            ...
            <div className=' bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100'>
              ...
              <div className=' space-y-2 sm:space-y-3'>
                {tasks.slice(0,3).map((task) => (
                  <div key={task._id || task.id} className=' flex items-center justify-between p-2 sm:p-3 hover:bg-purple-50/50 rounded-lg
