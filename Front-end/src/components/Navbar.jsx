...
import { ChevronDown, LogOut, Swords, Cog } from 'lucide-react';
...
const Navbar = ({ user = {}, onLogout }) => {
  ...
  return (
    <header className='sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-200 font-sans py-2'>
          ...
          <div ref={menuRef} className="relative">
            ...
            >
              ...
              <div className="text-left hidden md:block">
                ...
                <p className="text-xs text-gray-500 font-normal">{user?.email || 'No email'}</p>
              </div>
            ...
            {menuOpen && (
              <ul 
                className="absolute top-14 right-0 w-56 bg-white rounded-2xl shadow-xl border border-purple-100 z-50 overflow-hidden"
                role="menu"
              >
                <li className="p-2">
                  <button 
                    onClick={handleProfileClick}
                    className='w-full px-4 py-2.5 text-left hover:bg-purple-50 text-sm text-gray-700 transition-colors flex items-center gap-2 rounded-lg' 
                    role='menuitem'
                  >
                ...
                <li className="p-2">
                  <button 
                    ...
                    className="flex w-full items-center gap-2 rounded-lg px-4 py-2.5 text-sm hover:bg-red-50 text-red-600 transition-colors"
                    role='menuitem'
                  >
