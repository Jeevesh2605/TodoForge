    ...
    <div className={CT_CLASSES.page}>
      <div className={CT_CLASSES.header}>
        <div className={CT_CLASSES.titleWrapper}>
          <h1 className={`${CT_CLASSES.title} flex items-center gap-2`}>
      ...
      <div className={CT_CLASSES.list}>
        {completedTasks.length === 0 ? (
          <div className={CT_CLASSES.emptyState}>
            ...
            <h3 className="text-lg font-semibold text-black mb-2">No Completed Tasks</h3>
            <p className="text-sm text-black">You have not completed any tasks yet.</p>
          </div>
        ) : (
